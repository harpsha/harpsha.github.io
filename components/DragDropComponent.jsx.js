...
const DragDropCartRow = React.createClass({
    ...
    render() {
        return (
            <tr>
                <td>
                    <Thumbnail src={'img/' + this.props.item.data.thumbnail} />
                </td>
                {this.props.columns.map(column => {
                    return (
                        <td key={column}>
        ...
        return (
            <div className='container'>
                        ...
                        {this.state.purchase && (
                            <div>
                                <Alert bsStyle='warning'>
                                    API call to website cart here <i className='fa fa-smile-o' />
                                </Alert>
                                <Table>
                                    <tbody>
                ...
                <Grid>
                    <Griddle 
                      showFilter              = {true}
                      columns                 = {['Seller', 'Title', 'Label', 'Country', 'Weight', 'Format', 'Price']}
